        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center text-sm">
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-2">
              ...
              <span>+34 961 540 042</span>
            </div>
            <div className="flex items-center space-x-2">
              <Mail className="w-4 h-4" />
              <span>ms@msbelt.com</span>
            </div>
          </div>
          <div className="hidden md:block">
            <span className="text-orange-400 font-semibold">60+ Years of Excellence</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              <a 
                ...
                className="nav-link text-slate-700 hover:text-orange-600 font-medium transition-all duration-300 hover:scale-105"
              >
                Home
              </a>
              <a 
            ...
            <div className="md:hidden py-4 border-t">
              <nav className="flex flex-col space-y-4">
                ...
                <a 
                  href="#products" 
                  onClick={(e) => handleNavClick(e, 'products')}
                  className="nav-link text-slate-600 hover:text-orange-600 font-medium transition-all duration-300 hover:scale-105"
                >
                  Products
                </a>
                <a 
